...
Delta specification for the authentication capability. Extends the existing authentication spec with password reset, email verification, change password, and password validation requirements.
