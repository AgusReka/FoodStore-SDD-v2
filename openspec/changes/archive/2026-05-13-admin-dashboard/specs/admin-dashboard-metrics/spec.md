# admin-dashboard-metrics Specification (Delta)

## Purpose
Dashboard administrativo con KPIs del negocio, gráficos de órdenes e ingresos, y cards de resumen — reemplaza el placeholder actual de AdminDashboard.tsx.
