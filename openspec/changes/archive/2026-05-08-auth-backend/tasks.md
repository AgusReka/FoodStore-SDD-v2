...
- [ ] 6.4 Verify password reset flow end-to-end: forgot → reset → login with new password
- [ ] 6.5 Verify email verification flow: send → verify → confirm is_verified=True
- [ ] 6.6 Verify change password flow: change → old password rejected → new password works
