# frontend-config Specification

## Purpose
Shared configuration constants and route path definitions for the FoodStore frontend.
...
- **THEN** the following constants SHALL be available:
  ...
  - `ACCESS_TOKEN_EXPIRY_MS` — access token expiry in ms (30 minutes)
